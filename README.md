...
By using this file, you agree that the author is not liable for any misuse, damage, or illegal activity arising from its deployment.

## 🎯 Usage
- Use locally for demo purposes
- Deploy in sandboxed lab VMs
- Integrate in red team infrastructure for awareness training
